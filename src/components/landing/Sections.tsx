...
const STEPS = [
  ...
  { n: "04", title: "預覽並存檔", desc: "確認卷面無誤後儲存。試題卷與解答卷各一份 PDF，存入你選的資料夾，並自動依科目建立子資料夾。" },
];
...
const FAQS = [
  ...
  {
    q: "檔案存在哪裡？",
    a: "第一次儲存時，瀏覽器會請你選一個資料夾（建議選「模擬考題」），之後會記住，並自動在裡面依科目建立子資料夾；檔名含日期，同名檔案已存在時自動加流水號，不會覆蓋舊檔。此功能需要 Edge 或 Chrome，其他瀏覽器會改為直接下載。",
  },
];
